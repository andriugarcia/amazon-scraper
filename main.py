...
if __name__ == "__main__":
    links = [
        'https://www.amazon.es/s?rh=n%3A2846220031%2Cn%3A%212846221031%2Cn%3A3074028031%2Cn%3A3074052031%2Cn%3A3074245031', #Gorro
        'https://www.amazon.es/s?rh=n%3A2846220031%2Cn%3A%212846221031%2Cn%3A3074028031%2Cn%3A3074052031%2Cn%3A3074235031', #Bufandas
        'https://www.amazon.es/s?rh=n%3A2846220031%2Cn%3A%212846221031%2Cn%3A3074028031%2Cn%3A3074052031%2Cn%3A3074241031', # Gafas y Accesorios
        'https://www.amazon.es/s?rh=n%3A2846220031%2Cn%3A%212846221031%2Cn%3A3074028031%2Cn%3A3074064031%2Cn%3A14704098031%2Cn%3A2949401031', #Sudadera
        'https://www.amazon.es/s?rh=n%3A2846220031%2Cn%3A%212846221031%2Cn%3A3074028031%2Cn%3A3074055031%2Cn%3A3074053031', # Blusas y Camisas
        'https://www.amazon.es/s?rh=n%3A2846220031%2Cn%3A%212846221031%2Cn%3A3074028031%2Cn%3A3074055031%2Cn%3A3074257031', #Camisetas sin Mangas
        'https://www.amazon.es/s?rh=n%3A2846220031%2Cn%3A%212846221031%2Cn%3A3074028031%2Cn%3A3074074031' #Vestidos
    ]
    categories = [
        'hat', 'scarf', 'accessory', 'sweatshirt', 'shirt', 't-shirt', 'dress'
    ]
    for step in range(1, 50):
        ...
        while linkIndex < len(links):
            ...
            images=[] # Images
            srcsets=[] # Srcsets for responsive
            urls=[] # URLS
            for i in range(1,no_pages):
                print("starting thread: ",i)
                p[i] = threading.Thread(target=get_data, args=(i+step*8,q,links[linkIndex]))
                p[i].start()
            ...
            print([len(products), len(brands), len(prices), len(ratings), len(images), len(urls)])
            # print([len(products), len(prices)])
            df = pd.DataFrame({'asin':asins, 'name':products, 'brand':brands, 'price':prices, 'ratings':ratings, 'image':images, 'srcset':srcsets, 'url': urls, 'categorie': categories[linkIndex]})
